...
subset <-
  ...
  filter(Date <= as.Date("2020-07-27"))
...
graph_total_active_county_percapita <-
  ...
  geom_vline(xintercept = as.Date("2020-07-27"), linetype = "dashed") +
  annotate("text", size = 4, label = "Banned by Derick Williams", x = as.Date("2020-07-29"), y = 0.0023, angle = "90") +
